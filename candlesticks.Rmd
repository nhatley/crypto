...
### Six months
```{r, six_months, fig.width=8, fig.height=6.5}
    all_data %>%
...
```{r, six_months eth, fig.width=8, fig.height=8}
    all_data %>%
    filter(duration=="six_months") %>% 
...
```{r, six_months ltc, fig.width=8, fig.height=8}
    all_data %>%
    filter(duration=="six_months") %>% 
...
```{r, six_months xrp, fig.width=8, fig.height=8}
    all_data %>%
    filter(duration=="six_months") %>% 
